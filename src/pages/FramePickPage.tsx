...
const LAYOUTS: LayoutOption[] = [
  {
    count: 1,
    label: "1 photo",
    desc: "one big portrait",
    preview: { cols: 1, rows: 1 },
  },
  {
    count: 2,
    label: "2 photos",
    desc: "pick orientation",
    preview: { cols: 1, rows: 2 },
  },
  {
    count: 4,
    label: "4 photos",
    desc: "pick orientation",
    preview: { cols: 1, rows: 4 },
  },
  {
    count: 6,
    label: "6 photos",
    desc: "full grid",
    preview: { cols: 2, rows: 3 },
  },
  {
    count: 8,
    label: "8 photos",
    desc: "double quad",
    preview: { cols: 2, rows: 4 },
  },
  {
    count: 10,
    label: "10 photos",
    desc: "mega strip",
    preview: { cols: 2, rows: 5 },
  },
];
...
export default function FramePickPage() {
  ...
  const getActualShotCount = (layout: PhotoLayout): number => {
    ...
    if ([6, 8, 10].includes(layout)) return 10;
    return layout;
  };
      ...
      <main className="frame-pick-main">
        <div className="frame-pick-header">
          ...
          <p className="page-subtitle">
            How many photos do you want in your strip?
          </p>
        </div>
